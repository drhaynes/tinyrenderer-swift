...
let lineColour = Colour(r: 255, g: 255, b: 254)
drawLine(Point2d(x: 13, y: 20), end: Point2d(x: 80, y: 220), colour: lineColour, image: image)
drawLine(Point2d(x: 20, y: 13), end: Point2d(x: 300, y: 180), colour: lineColour, image: image)
